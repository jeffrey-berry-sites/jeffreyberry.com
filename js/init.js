...
$(document).ready(function(){
	...
	$('.bg_hover').on('mouseenter', function(){
		...
		$(this).parent().parent().siblings('.caption-below').css('opacity', '0');
		$(this).parent().parent().siblings('.caption-over').css('opacity', '1');
	...
	$('.bg_hover').on('mouseleave', function(){
		$(this).css('opacity', '0');
		$(this).parent().parent().siblings('.caption-below').css('opacity', '1');
		$(this).parent().parent().siblings('.caption-over').css('opacity', '0');
